import React, { FC, ReactElement, useState, forwardRef, PropsWithRef, useImperativeHandle } from 'react';
...
// const ContextMenu: FC<ContextMenuProps> = ({ isOpen = false }): ReactElement => {
//   const [menuOpen, setMenuOpen] = useState(isOpen === undefined ? false : isOpen);
